...
public class BBSVO {
	...
	public String toString() {
		return "BBSVO [bbs_key=" + bbs_key + ", bbs_writer=" + bbs_writer + ", bbs_title=" + bbs_title
				+ ", bbs_contents=" + bbs_contents + ", bbs_regDate=" + bbs_regDate + ", bbs_uDate=" + bbs_uDate
				+ ", bbs_photo=" + bbs_photo + ", bbs_type=" + bbs_type + "]";
	}
}
