    ...
    return (
        <>
            ...
            <div className='text-end'  >
                <Button variant="contained" color='success' onClick={onClickseller} className='me-3'>판매 내역</Button>
                <Button variant="contained" color='success' onClick={onClickreview}>입찰 내역</Button>
            </div>
            {view === 'seller' && (
                <>
